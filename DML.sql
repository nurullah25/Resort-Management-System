...
MERGE customer_Merge AS TARGET 
...
WITH CTE_ItemCost(orderId,itemName,unitPrice,quantity,Total_Price)
AS
(
SELECT o.orderId, o.itemName, o.unitPrice,o.quantity, o.quantity * o.unitPrice AS Total_Price 
FROM tbl_Order o
)
SELECT orderId,itemName,unitPrice,quantity, Total_Price 
FROM CTE_ItemCost 
